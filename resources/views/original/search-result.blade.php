    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card p-t-b-40" data-backround-image="{{ url('assets/media/image/image1.jpg') }}">
                            <div class="container">
                        ...
                        <h4 class="mb-5">
                            <i data-feather="search"></i>
                            420 results found for: <span class="text-primary">“Lorem Ipsum”</span>
                        </h4>
                        <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#clasic" role="tab"
                                   aria-controls="clasic" aria-selected="true">Clasic</a>
                            </li>
                            <li class="nav-item">
